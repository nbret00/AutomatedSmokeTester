...
import com.safeway.app.appcert.util.smoketester.TestCaseReader;
 ...
 * @author nbret00
 */
public class SmokeTester_UnitTest {
    ...
    public void executeSmokeTest() throws Exception {
        ...
        while (i.hasNext()) {
            ...
            log_execution = log_execution + "\nStart smoke testing for application code: " + testexecution.getAppCode();
